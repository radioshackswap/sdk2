...
const WETH = _WETH[ChainId.AVALANCHE]
    ...
    describe(`decimals permutation: ${decimals}`, () => {
      ...
      describe('Trade', () => {
        ...
        it('TradeType.EXACT_INPUT', () => {
          ...
          expect(trade.outputAmount.greaterThan(expectedOutputAmount)).toBe(true)
          ...
          expect(trade.executionPrice.quote(inputAmount).greaterThan(expectedOutputAmount)).toBe(true)
          //expect(trade.executionPrice.invert().quote(expectedOutputAmount)).toEqual(inputAmount)

          expect(trade.nextMidPrice.toSignificant(18)).toEqual('1.3891204089570484')
          expect(trade.nextMidPrice.invert().toSignificant(18)).toEqual('0.71988')
        ...
        it('TradeType.EXACT_OUTPUT', () => {
          ...
          //expect(trade.executionPrice.invert().toSignificant(18)).toEqual('0.600300300301504514')
          ...
          //expect(trade.nextMidPrice.invert().toSignificant(18)).toEqual('0.71939987988012')

          //expect(trade.priceImpact.toSignificant(18)).toEqual('16.7083541772556288')
        })
