...
import { ChainId, CurrencyAmount, CETH, Pair, Percent, Route, Router, Token, TokenAmount, Trade, WETH } from '../src'
...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(
    new TokenAmount(WETH[ChainId.AVALANCHE], '1000'),
    ...
    describe('exact in', () => {
      it('ether to token1', () => {
        const result = Router.swapCallParameters(
          Trade.exactIn(
            new Route([pair_weth_0, pair_0_1], CETH_AVALANCHE, token1),
      ...
      it('token1 to ether', () => {
        const result = Router.swapCallParameters(
          Trade.exactIn(
            new Route([pair_0_1, pair_weth_0], token1, CETH_AVALANCHE),
